(function() {
  var CWD, compileJade, compileSource, compileStylus, createBlogPost, createFolders, createProject, entities, exec, fs, jottOptions, log, moment, path, projectDir, prompt, quitWithMsg, readSettings,
    _this = this;
