(function() {
  var compileJade, compileSource, compileStylus, createBlogPost, createFolders, createProject, entities, exec, fs, jottOptions, log, moment, path, projectDir, prompt, readSettings,
    _this = this;
